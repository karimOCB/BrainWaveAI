    ...
    <div className="container md:pb-10">
      ...
      <div className="relative grid gap-6 md:grid-cols-2 md:gap-4 md:pb-[7rem]">
        {roadmap.map((item) => {
          ...
          return (
            <div key={item.id} className="relative p-8 bg-n-8 border border-n-6 
                rounded-[2.44rem] overflow-hidden xl:p-15 even:md:translate-y-[6rem]"
            >
              <div>
                ...
                <div className="relative z-1">
                  <div className="flex items-center justify-between mx-4 mb-8 mt-1">
