  ...
  return (
    ...
    lg:backdrop-blur-sm ${openNavigation ? 'bg-n-8' : 'bg-n-8/90 backdrop-blur-sm'}`}>
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav className={`${openNavigation ? 'flex top-0' : 'hidden'} fixed top-[5-rem] left-0 right-0 bottom-0
        ...
        <a href='#signup' className='button hidden mr-8 text-n-1/50 transtion-colors
        hover:text-color-n-1 lg:block'>
          New account
        </a>
