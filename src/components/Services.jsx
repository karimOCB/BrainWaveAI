        ...
        <div className="relative">
          ...
          >
            ...
            <ScrollParallax isAbsolutelyPositioned>  
              <Generating className="absolute right-4 left-4 bottom-20 border-n-1/10 border 
                md:bottom-28 md:left-[15%] lg:left-[40%] lg:right-auto lg:bottom-25 lg:-translate-x-1/2 md:w-96"
              />
            </ScrollParallax>  
          </div>
                ...
                <ul className="flex items-center justify-between ">
                  {brainwaveServicesIcons.map((item, index) => (
                    <li key={index} className={`flex items-center justify-center rounded-2xl 
                      ${index === 2 ? 'w-[3rem] h-[3rem] p-0.5 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]' 
