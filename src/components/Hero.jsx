         ...
         mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]'>
          <h1 className='h1 mb-8'>
            ...
            <span className='inline-block relative'>
              Brainwave 
              <img src={curve} width={624} height={28} alt='Curve'
            ...
            <div className='relative bg-n-8 rounded-[1rem]'>
              ...
              <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden 
                ...
                <img src={robot} className="w-full scale-[1.7] translate-y[8%]
                  md:scale-[1] md:-translate-y-[10%] lg:-translate-y-[23%]" width={1024} 
                  height={490} alt='AI'
                />
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <ul className='hidden absolute xl:-left-[4rem] bottom-[7.5rem] px-1 py-1 
                    bg-n-9/40 backdrop-blur border border-n-1/10 rounded-2xl lg:flex lg:-left-[2rem]'>
                ...
                <ScrollParallax isAbsolutelyPositioned>
                    <Notification title="Code generation" className='hidden absolute 
                      -right-[5.5rem] bottom-[11rem] w-[18rem] lg:flex lg:-right-[2rem]'
                    />
                </ScrollParallax>
              </div>
            </div> 
